...
def read_options():
    ...
    parser.add_argument("--max_rel", default=5, type=int)
    parser.add_argument("--max_tail", default=10, type=int)
    ...
    parser.add_argument("--num_transformer_layers", default=1, type=int)
    parser.add_argument("--num_transformer_heads", default=2, type=int)
    parser.add_argument("--warm_up_step", default=1000, type=int)
    ...
    parser.add_argument("--Bilstm_seq_length", default=3, type=int)
    parser.add_argument("--BiLSTM_input_size", default=100, type=int)
